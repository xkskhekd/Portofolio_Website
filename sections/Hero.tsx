...
export default function Hero() {
  ...
  const PhotoBlock = (
    ...
    >
      ...
      <Image
        src="/images/photoss.png"
        alt="Profile Photo"
        fill
        style={{ objectFit: "cover", objectPosition: "top", borderRadius: "24px", filter: "grayscale(20%)" }}
      />
      <div style={{
        position: "absolute", bottom: 0, left: 0, right: 0, height: "100px",
        background: "linear-gradient(to top, #0B0B0B, transparent)",
        borderRadius: "0 0 24px 24px", zIndex: 1,
      }} />
      <div style={{
        position: "absolute", bottom: "20px", left: "50%", transform: "translateX(-50%)",
        background: "rgba(11,11,11,0.85)", border: "1px solid rgba(34,197,94,0.25)",
        backdropFilter: "blur(8px)", borderRadius: "999px", padding: "6px 16px",
  ...
  return (
    ...
    >
      ...
      {/* Glow orb */}
      <div style={{
        position: "absolute", top: "25%", right: "20%", width: "500px", height: "500px",
        ...
        <div>
          ...
          >
            <div style={{
              ...
              background: "#141414", border: "1px solid rgba(34,197,94,0.25)",
          ...
          <motion.p
            ...
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0, duration: 0.7 }}
            style={{ fontSize: "14px", color: "#FFFFFF", fontFamily: "monospace", marginBottom: "20px", letterSpacing: "0.05em" }}
          >
          ...
          <motion.h1
            ...
            style={{
              ...
              fontWeight: 700, lineHeight: 1.0, letterSpacing: "-0.02em", marginBottom: "0px",
            }}
          >
          ...
          {/* Foto muncul di sini khusus mobile — setelah headline, sebelum bio */}
          {isMobile && PhotoBlock}
          ...
          <motion.p
            ...
            style={{
              fontSize: "12px", color: "#9CA3AF", maxWidth: "480px",
              lineHeight: 1.8, marginBottom: "32px", marginTop: "20px",
            }}
          >
          ...
          >
            {["Power Systems", "Machine Learning", "Embedded Systems", "ESP32/Arduino", "Python"].map((skill) => (
              <span key={skill} style={{
                fontSize: "12px", color: "#6B7280", border: "1px solid rgba(255,255,255,0.07)",
          ...
          >
            <a href="/CV_Fathi_Annaqi.pdf" download="CV_Fathi_Annaqi.pdf" style={{
              display: "inline-flex", alignItems: "center", gap: "8px", fontSize: "14px",
              color: "#0B0B0B", background: "#22C55E", padding: "10px 20px",
            ...
            <a href="#projects" onClick={(e) => {
              ...
              style={{
                ...
                color: "#6B7280", textDecoration: "none", padding: "10px 4px", cursor: "pointer",
              }}>
              Lihat proyek saya
              <ArrowDown size={14} />
            </a>
      ...
      {!isMobile && (
        ...
        >
          ...
          <motion.div
            ...
            style={{ width: "1px", height: "32px", background: "linear-gradient(to bottom, rgba(34,197,94,0.5), transparent)" }}
          />
        </motion.div>
      )}
    </section>
